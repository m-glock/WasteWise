...
class FullItemDetailWidget extends StatefulWidget {
  const FullItemDetailWidget({Key? key, required this.item}) : super(key: key);

  final Item item;

  @override
  State<FullItemDetailWidget> createState() => _FullItemDetailWidgetState();
}

class _FullItemDetailWidgetState extends State<FullItemDetailWidget> {
